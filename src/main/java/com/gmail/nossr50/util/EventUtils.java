...
public class EventUtils {
    ...
    public static boolean shouldProcessEvent(Block block, boolean isExtendEvent) {
        ...
        String lastAction = block.hasMetadata(mcMMO.pistonDataKey) ? block.getMetadata(mcMMO.pistonDataKey).size()>0 ? block.getMetadata(mcMMO.pistonDataKey).get(0).asString() : "":"";
