...
/**
 * This util class is responsible for mapping the correct potion effect types for the server
 * version. This is necessary because the potion effect types have changed between versions. This
 * util class will provide the correct potion effect types for the server version.
 */
final public class PotionEffectUtil {
    ...
    private static PotionEffectType getHasteLegacy() {
        try {
            Object potionEffectTypeWrapper = PotionEffectType.class.getField("FAST_DIGGING")
                    .get(null);
            return (PotionEffectType) potionEffectTypeWrapper;
        } catch (IllegalAccessException | NoSuchFieldException e) {
            return null;
    ...
    /**
     * Get the Haste potion effect type. This will return the correct potion effect type for the
     * server version.
     *
    ...
    /**
     * Get the Nausea potion effect type. This will return the correct potion effect type for the
     * server version.
     *
