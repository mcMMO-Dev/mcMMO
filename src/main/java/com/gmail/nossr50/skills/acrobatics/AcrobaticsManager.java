        ...
        if (!isFatal(modifiedDamage)
            ...
            if (SkillUtils.cooldownExpired(mmoPlayer.getRespawnATS(),
                ...
                if (attacker instanceof Mob mob) {
                    //Limit how much Dodge XP a single mob can hand out
                    if (!ExperienceConfig.getInstance().isAcrobaticsDodgeXpFarmingPrevented()
                            || DodgeXpTracker.tryConsumeXpReward(mob)) {
