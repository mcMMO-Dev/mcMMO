...
public final class FlatfileDatabaseManager implements DatabaseManager {
    ...
    private int getSkillIndex(PrimarySkillType skill) {
        switch (skill) {
            case PrimarySkillType.ACROBATICS:
                return SKILLS_ACROBATICS;
            case PrimarySkillType.ALCHEMY:
                return SKILLS_ALCHEMY;
            case PrimarySkillType.ARCHERY:
                return SKILLS_ARCHERY;
            case PrimarySkillType.AXES:
                return SKILLS_AXES;
            case PrimarySkillType.EXCAVATION:
                return SKILLS_EXCAVATION;
            case PrimarySkillType.FISHING:
                return SKILLS_FISHING;
            case PrimarySkillType.HERBALISM:
                return SKILLS_HERBALISM;
            case PrimarySkillType.MINING:
                return SKILLS_MINING;
            case PrimarySkillType.REPAIR:
                return SKILLS_REPAIR;
            case PrimarySkillType.SWORDS:
                return SKILLS_SWORDS;
            case PrimarySkillType.TAMING:
                return SKILLS_TAMING;
            case PrimarySkillType.UNARMED:
                return SKILLS_UNARMED;
            case PrimarySkillType.WOODCUTTING:
